...
// Separate component for breadcrumbs that uses useSearchParams
function BreadcrumbsContent({ pathname }: { pathname: string }) {
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-black border-b border-gray-800">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center">
            <Suspense fallback={
              <div className="text-xl font-bold tracking-tighter text-gray-400">
                DARCE SIDE
              </div>
            }>
              <BreadcrumbsContent pathname={pathname} />
            </Suspense>
          </div>
